...
try:
  with open(r"D:\effinet\Smart-Parking-Space-Detector-using-YOLO-and-OpenCV-main\Space_ROIs",
              'rb') as f:
...
while True:
    img = cv2.imread(r"D:\effinet\Smart-Parking-Space-Detector-using-YOLO-and-OpenCV-main\ROI_Reference.png")
